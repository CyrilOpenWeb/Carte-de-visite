...
export default function Page2() {
  useEffect(() => {
    document.title = "Carte de visite - Cyril Rousteau";

    const metaDescription = document.createElement("meta");
    metaDescription.name = "description";
    metaDescription.content = "Ceci est la carte de visite de Cyril Rousteau, Développeur web.";
    ...
    linkFonts.href = "https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap";
